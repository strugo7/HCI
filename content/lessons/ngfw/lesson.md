...
:::references
- מצגת 06 — IDS/IPS/NGFW, שקופיות 32–43: אתגרי היישומים (32), "A firewall exists to allow or block traffic" (33), FW מול IPS והתיקון לתפיסה המוטעית (34), Technology Sprawl & Creep (35), NGFW / UTM (36), חמש היכולות (37), Stateful FW — Gen 3 (38), משוואת ה-NGFW (39), App-ID מול Legacy Firewall (40–43).
- מצגת 05 — Firewalls & Defense in Depth, שקופיות 31–33: GEN AI FW, Request/Response validation, טבלת AI-FW מול NG-FW.
- מבחני עבר: 2024 שאלה 3 (יתרון NGFW על חומת אש מסורתית), 2025 שאלה 20 (DPI וסינון אפליקטיבי בתוך פרוטוקול מותר).
:::
