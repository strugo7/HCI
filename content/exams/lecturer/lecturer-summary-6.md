...
Learning Objective: להסביר כיצד ארכיטקטורת ה-DMZ מבודדת שירותים פומביים ומאבטחת גישה לרשת הפנימית.
...
Learning Objective: ליישם את עקרונות Zero Trust על תעבורת VPN באמצעות סיום החיבור באזור מבודד ובדיקתו.
...
Learning Objective: להסביר כיצד ניתן לזהות איומים בתעבורה מוצפנת באמצעות ניתוח מטא-נתונים (Metadata).
...
Learning Objective: לסווג מתקפת DDoS למושג ה-Availability ולסוג האיום Disruption במודל RFC 2828.
...
Learning Objective: להסביר כיצד Deep Packet Inspection (DPI) ו-App-ID מונעים מעקף של חומת אש בפורטים מותרים.
...
Learning Objective: להבחין בין משטח התקיפה (Attack Surface) לבין וקטור התקיפה (Attack Vector) על פי תרחיש פריצה.
...
Learning Objective: לתאר מנגנוני הגנה בשכבת האפליקציה למניעת העלאה והרצה של Web Shell.
...
Learning Objective: לזהות את מאפייני הפעולה של נוזקת כופר (Ransomware).
...
Learning Objective: להסביר כיצד Rootkit מאפשר שמירה על אחיזה (Persistence) תוך הסתרת נוכחותו.
...
Learning Objective: למקם מערכת DLP בשכבת הנתונים (Data) כחלק ממודל הגנה לעומק.
...
Learning Objective: לסווג השתלטות על שירותים או הרשאות במערכת כ-Usurpation לפי RFC 2828.
...
Learning Objective: להסביר את ההשלכות של פריסת Inline של IPS במקרה של False Positive.
...
Learning Objective: לנמק מדוע הגנה היקפית (Perimeter Security) קלאסית אינה מספיקה בסביבות ענן.
...
Learning Objective: להסביר את החשיבות של החלת מנגנוני זהות והזדהות על כלל הישויות ברשת (אדם ומכונה).
...
Learning Objective: להסביר את מגבלת מערכות גילוי מבוססות חתימות מול התקפות Zero-Day.
...
Learning Objective: להשוות בין יכולות ניטור המארח של HIDS לבין יכולות ניטור הרשת של NIDS.
...
Learning Objective: להסביר את החשיבות של סיווג מידע (Data Classification) בהכוונת משאבי אבטחה.
...
Learning Objective: להסביר כיצד יש לאבטח ולבקר תעבורה מה-DMZ לרשת הפנימית המאובטחת.
...
Learning Objective: לסווג התקפות מניעת שירות (DDoS/Resource Exhaustion) לקטגוריית Disruption לפי RFC 2828.
...
Learning Objective: להסביר מדוע WAF הוא המענה היעיל ביותר נגד התקפות אפליקטיביות כגון XSS ו-SQL Injection.
