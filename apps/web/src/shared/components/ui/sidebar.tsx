        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              <SheetTitle>סרגל ניווט</SheetTitle>
              <SheetDescription>תפריט הניווט הראשי של המערכת.</SheetDescription>
            </SheetHeader>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <PanelLeft />
      <span className="sr-only">פתיחה או סגירה של סרגל הניווט</span>
    </Button>
  )
})
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      data-sidebar="rail"
      aria-label="פתיחה או סגירה של סרגל הניווט"
      tabIndex={-1}
